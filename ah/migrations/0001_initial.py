    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_worker_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Complaint',
            fields=[
                ...
                ('case_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ah.case')),
            ],
        ),
        migrations.AddField(
            model_name='case',
            name='worker_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='worker_id', to='ah.worker'),
        ),
    ]
